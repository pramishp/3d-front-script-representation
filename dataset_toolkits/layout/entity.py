...
class Wall:
    ...
    def to_language_string(self):
        ...
        language_string = (
            ...
            f"({self.ax:.2f},{self.ay:.2f},{self.az:.2f},"
            f"{self.bx:.2f},{self.by:.2f},{self.bz:.2f},"
            f"{self.height:.2f},{self.thickness:.2f})"
        )
...
class Door:
    ...
    def to_language_string(self):
        ...
        language_string = (
            f"{self.entity_label}_{self.id}={capitalized_label}(wall_{self.wall_id},"
            f"{self.position_x:.2f},{self.position_y:.2f},{self.position_z:.2f},"
...
class Bbox:
    ...
    def to_language_string(self):
        ...
        language_string = (
            f"{self.entity_label}_{self.id}={capitalized_label}({self.class_name},"
            f"{self.position_x:.2f},{self.position_y:.2f},{self.position_z:.2f},"
            f"{self.angle_z:.2f},{self.scale_x:.2f},{self.scale_y:.2f},{self.scale_z:.2f})"
        )
        return language_string
